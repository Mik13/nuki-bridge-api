 ...
 *
 * @param {String}      url            the actuall callback url, no listening is required ( e.g. already implemented )
 * @returns {Promise}
 */
Nuki.prototype.addCallbackUrl = function addCallbackUrl(url, listen) {
  var self = this;
  return this
...
/**
 * This function requests the simple lock action to lock
 *
 * @returns {Promise<Boolean>}
 */
Nuki.prototype.lock = function lock () {
  var self = this;
...
/**
 * This function requests the simple unlock action to unlock
 *
 * @returns {Promise<Boolean>}
 */
Nuki.prototype.unlock = function lock () {
  var self = this;
